 ...
 *
 * STRICT RULE: provider photos never appear on the card. While the painting
 * generates, a stylized gothic art-skeleton frame breathes (never a raw
 * cover photo); when the painting arrives it cross-fades into place. The
 * provider only supplies the 30s preview stream behind the mute/play toggle.
 */
...
export function QuizCard({
  ...
  return (
    ...
    >
      ...
      {/* Artwork window — the generated painting, or the stylized art-skeleton
          while it forms. Raw provider covers are never card imagery. */}
