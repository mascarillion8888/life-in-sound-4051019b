...
## Ana Yasa — Zorunlu Referans

Her görev başlamadan önce `docs/ANA_YASA.md` dosyasını oku. Bu dosya
projenin hedef mimarisini, veri sözleşmesini, öncelik sırasını (P0-P5)
ve kesin yasakları tanımlar.

Önemli: Bu dosyadaki hiçbir madde "kodun şu an ne yaptığının kanıtı"
değildir — kod ile çelişirse KOD esastır, çelişkiyi STATE.md'ye not et.
🔵 TASARIM etiketli bölümler (Visual Multiverse Engine, First Melody
Hit, Emo-Location) henüz production'da YOK — bunlara kod yazmadan önce
onay iste.